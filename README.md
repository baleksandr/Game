...
## 🎮 Game Lobby — Інтерактивний Космічний Портал

Головне меню для запуску всіх ігор — це не просто список, а **повноцінний інтерактивний космічний простір**!

### 🪐 Планети Сонячної системи

Кожна гра прив'язана до унікальної планети:

| Планета | Гра | Особливості |
|---------|-----|-------------|
| 🟤 Меркурій | Snake | Найближча до Сонця |
| 🟡 Венера | Tetris | Найгарячіша планета |
| 🔵 Земля | BattleShips | Наш дім |
| 🔴 Марс | Mario | Червона планета |
| 🟠 Юпітер | Space Shooter | Найбільша планета |

**Інтерактивність планет:**
- 🖱️ При наведенні — планети збільшуються та підсвічуються
- 🌟 Орбітальна анімація — кожна планета рухається своєю орбітою
- 💫 Кастомний курсор-комета слідує за мишкою
- 🎯 Клік на планету — запуск відповідної гри

### ⭐ Сузір'я

Фон оживлений **динамічними сузір'ями**:
- ✨ Зірки різної яскравості мерехтять
- 🔗 Лінії з'єднують зірки у сузір'я
- 🌌 Паралакс-ефект при русі мишки
- 💨 Комети періодично пролітають небом

### 🤖 Робот-помічник

В лобі є **інтерактивний робот-гід**:
- 👁️ Очі робота слідкують за курсором
- 💬 При наведенні — з'являються підказки про ігри
- 🎨 Анімована антена реагує на рухи
- 🌈 Підсвітка змінюється при взаємодії

### 🔊 Атмосфера

- 🎵 **8 космічних треків** фонової музики
- 🔉 Регулювання гучності через повзунок (довгий тап на кнопку звуку)
- 🎧 Музика продовжує грати при переході між секціями
...
> 💡 Для Mario та Shooter потрібен Vite dev server — лобі покаже інструкції автоматично!
...
├── .gitignore
│
├── lobby/              # 🚀 Інтерактивне лобі
│   ├── index.html      # Головна сторінка
│   ├── scripts/
│   │   ├── lobby.js    # Логіка лобі
│   │   ├── planets.js  # Планети та орбіти
│   │   ├── constellations.js  # Сузір'я
│   │   └── robot-guide.js     # Робот-помічник
│   ├── styles/
│   │   ├── lobby.css
│   │   ├── planets.css
│   │   └── robot-guide.css
│   ├── img/            # Зображення планет
│   └── lobbySounds/    # 8 космічних треків
│
├── battleShips/        # Морський бій
│   ├── index.html
│   ├── bord.js
